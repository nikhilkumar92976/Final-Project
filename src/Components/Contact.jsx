...
function Contact() {
  ...
  return (
    <div className='h-screen w-screen bg-black px-[20%] py-[6%] text-white flex overflow-y-auto overflow-x-hidden'>
      ...
      <div className='w-full'>
        ...
        <form onSubmit={onSubmit} className='flex flex-col '>
          ...
          {
            submit ?
             (<div  className='pl-10 py-2 bg-yellow-600 w-[20%] ml-[40%] rounded text-xl '>Done 👍🏻</div>):( <button type="submit" className='px-3 py-2 bg-[#6556CD] w-[20%] ml-[40%] rounded text-xl hover:bg-[#423591]'>Submit</button>)
          }
