...
function Topnav() {
  ...
  return (
    <div className='w-full h-[8vh] relative flex items-center justify-start ml-[15%] my-2'>
      ...
      {query.length>0 && <i onClick={()=>setquery("")} className="text-zinc-400 text-3xl ri-close-large-line"></i>}

      <div className='absolute z-50  w-[60%] max-h-[55vh] bg-zinc-200 left-[4vw]  top-[8vh] overflow-auto rounded'>
